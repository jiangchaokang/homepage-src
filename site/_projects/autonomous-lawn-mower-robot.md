...
cover: "/assets/media/projects/lawn-mower/project_05_up_down_slope.mp4"
cover_type: "video"
featured: true
order: 40
rich_body: true
    ...
    <div class="tech-panel is-active" role="tabpanel" data-panel="slope">
      ...
      <div class="module-grid">
        ...
        <div class="viz-box">
          ...
          <div class="viz-media">
            <figure>
              <video autoplay muted loop playsinline preload="metadata" poster="{{ '/assets/media/projects/lawn-mower/project_05_up_down_slope_poster.jpg' | relative_url }}" disablepictureinpicture disableremoteplayback>
                <source src="{{ '/assets/media/projects/lawn-mower/project_05_up_down_slope.mp4' | relative_url }}" type="video/mp4">
              </video>
              <figcaption>Autonomous up/down slope traversal for loading and unloading.</figcaption>
            </figure>
            <figure>
              <video autoplay muted loop playsinline preload="metadata" poster="{{ '/assets/media/projects/lawn-mower/project_03_ob_on_slope1_poster.jpg' | relative_url }}" disablepictureinpicture disableremoteplayback>
                <source src="{{ '/assets/media/projects/lawn-mower/project_03_ob_on_slope1.mp4' | relative_url }}" type="video/mp4">
              </video>
