      ...
      <div class="module-grid">
        ...
        <div class="viz-box">
          ...
          <div class="viz-media">
            ...
            <figure>
              <video autoplay muted loop playsinline preload="metadata" poster="{{ '/assets/media/projects/integrated-driving/project_12_slam_demo_poster.jpg' | relative_url }}" disablepictureinpicture disableremoteplayback>
                <source src="{{ '/assets/media/projects/integrated-driving/project_12_slam_demo.mp4' | relative_url }}" type="video/mp4">
              </video>
