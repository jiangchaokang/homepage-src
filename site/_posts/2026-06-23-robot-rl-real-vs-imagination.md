    ...
    <div class="project-body-main bx-body">
      ...
      <section class="bx-section">
        ...
        <figure class="bx-video is-wide">
          <video autoplay muted loop playsinline preload="metadata" disablepictureinpicture><source src="{{ '/assets/media/blog/rise_pi06/pi06.mp4' | relative_url }}" type="video/mp4"></video>
      ...
      <section class="bx-section">
        ...
        <figure class="bx-video is-wide">
          <video autoplay muted loop playsinline preload="metadata" disablepictureinpicture><source src="{{ '/assets/media/blog/rise_pi06/rise_methodology_Compositional_world_model.mp4' | relative_url }}" type="video/mp4"></video>
        ...
        <figure class="bx-video is-wide">
          <video autoplay muted loop playsinline preload="metadata" disablepictureinpicture><source src="{{ '/assets/media/blog/rise_pi06/rise_self_improve_loop.mp4' | relative_url }}" type="video/mp4"></video>
